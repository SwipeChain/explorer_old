<template>
  <div class="HeaderDefault">
    <div class="px-4 md:px-8 flex-auto flex">
      ...
      >
        <SvgIcon class="flex-none mr-3" name="menu" view-box="0 0 15 13" style="color: var(--color-theme-accents)" />
      ...
      <div class="flex-auto flex items-center justify-center">
        ...
        <label
          for="search"
          class="search-icon p-3 md:p-4 transition"
