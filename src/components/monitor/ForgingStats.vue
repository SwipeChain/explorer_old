  ...
  <div class="ForgingStats">
    ...
    >
      <div class="Meter mb-4 sm:mb-0 text-status-missed-round">
        ...
        <SvgIcon class="MeterIcon" name="missed-round" view-box="0 0 19 17" color="#707070" />
      </div>
      <div class="p-0 sm:pl-4">
        <div class="text-3xl semibold">
          {{ totals.missedRound }}
    ...
    >
      <div class="Meter mb-4 sm:mb-0 text-status-not-forging">
        ...
        <SvgIcon class="MeterIcon" name="not-forging" view-box="0 0 19 17" color="var(--color-theme-accents)" />
      </div>
      <div class="p-0 sm:pl-4">
        <div class="text-3xl semibold">
    ...
    <div class="w-1/2 lg:w-1/4 flex items-center px-6 my-6 flex-col sm:flex-row text-center sm:text-left">
      <div class="Meter mb-4 sm:mb-0 text-blue">
        <ArkMeter :percentage="percentage(totals.remainingBlocks)" color="var(--color-theme-accents)" />
      </div>
      <div class="p-0 sm:pl-4">
        <div class="text-3xl semibold">
