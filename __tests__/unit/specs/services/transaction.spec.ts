...
describe("Services > Transaction", () => {
  ...
  it("should return all transactions with a fee exceeding 25 SXP", async () => {
  ...
  it("should return all transactions with an amount between 5000 and 6000 SXP", async () => {
...
describe("Services > Transaction (2.6)", () => {
  beforeAll(() => {
    store.dispatch("network/setServer", "https://dexplorer.swipechain.org/api/v2");
  });
