...
describe("Mixins > Currency", () => {
  ...
  describe("rawCurrency", () => {
    it("should display selected cryptocurrency with 8 digits or less", () => {
      ...
      expect(wrapper.vm.rawCurrency(10.1234567891234, "SXP")).toEqual(displayCrypto(10.12345679));
      ...
      expect(wrapper.vm.rawCurrency(10.12345, "SXP")).toEqual(displayCrypto(10.12345));
    });
  ...
  describe("readableCurrency", () => {
    ...
    it("should properly format the given data", () => {
      expect(wrapper.vm.readableCurrency(100000000, null, "SXP")).toEqual("1 Ѧ");
