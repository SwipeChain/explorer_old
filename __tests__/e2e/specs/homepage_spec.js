  ...
  describe("Chart", () => {
    it("should be possible to persistently change type", () => {
      cy.get("button.chart-tab")
        .contains("Price")
        .should("have.class", "chart-tab-active");
    ...
    it("should be possible to change period", () => {
      ...
      cy.get("button.chart-tab")
        .contains("Day")
        .should("not.have.class", "chart-tab-active");
      cy.get("button.chart-tab")
        .contains("Week")
        .should("have.class", "chart-tab-active");
    });
      ...
      pages.forEach(page => {
        cy.get("h1").then($heading => {
          ...
          cy.get("button")
            .contains("Menu")
            .click();
          cy.get(".HeaderMenuDesktop button")
            .contains(page)
            .click();
  ...
  describe("Search", () => {
    it("should be possible to search for a known wallet", () => {
      cy.get("h1").then($heading => {
        ...
        cy.get(".HeaderDefault .search-input")
          .first()
          .click();
        cy.get(".HeaderSearch .search-input")
          .first()
          .type("SXP Bounty{enter}");
    ...
    it("should be possible to search for an address", () => {
      cy.get("h1").then($heading => {
        ...
        cy.get(".HeaderSearch .search-input")
          .first()
          .type("AUDud8tvyVZa67p3QY7XPRUTjRGnWQQ9Xv{enter}");
    ...
    it("should be possible to search for a block id", () => {
      cy.get("h1").then($heading => {
        ...
        cy.get(".HeaderSearch .search-input")
          .first()
          .type("13507259488170268466{enter}");
    ...
    it("should show a notice if nothing could be found", () => {
      cy.get("h1").then($heading => {
        ...
        cy.get(".HeaderSearch .search-input")
          .first()
          .type("asdfnothingfoundforthisvalueasdf{enter}");
